 ...
 * @co-author Trashkov Sergey
 * @version 0.2.5 dated Jun 20, 2017
 */
import java.awt.*;
...
class SimpleChatBot extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        if (message.getText().trim().length() > 0) {
			...
			//Write a chat history to a text file
			try {
                BufferedWriter bw = new BufferedWriter(new FileWriter("chat_history.txt", true));
